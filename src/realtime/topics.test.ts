...
describe("buildSubscribeTopic", () => {
  it("uses + wildcards for absent eventType and agentId", () => {
  ...
  it("substitutes both filters", () => {
    ...
    ).toBe("axonpush/o/a/1/agent.start/agent-1");
  });
...
describe("buildPublishTopic", () => {
  it("never has wildcards", () => {
    ...
    expect(topic).toBe("axonpush/o/a/1/custom/_");
